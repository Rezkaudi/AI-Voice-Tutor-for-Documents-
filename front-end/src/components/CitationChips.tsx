...
/**
 * Compact page-number badges, one per citation. The full quote stays on hover
 * as the native tooltip; the chip itself shows only `p.N` so a turn with five
 * citations still fits on one line. Active state lifts the badge with a thicker
 * ring and tinted fill — the same affordance the highlight uses in the doc.
 */
