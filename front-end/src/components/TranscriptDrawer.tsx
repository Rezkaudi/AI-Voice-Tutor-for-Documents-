...
export function TranscriptDrawer({ open, messages, onClose }: TranscriptDrawerProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cx(
          "fixed inset-y-0 right-0 z-50 flex w-[min(420px,92vw)] flex-col border-l border-[oklch(1_0_0/0.1)] bg-[radial-gradient(120%_80%_at_50%_0%,oklch(0.26_0.04_236)_0%,oklch(0.18_0.03_244)_70%)] shadow-[-24px_0_60px_oklch(0.05_0.02_244/0.6)] transition-transform duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] motion-reduce:transition-none",
